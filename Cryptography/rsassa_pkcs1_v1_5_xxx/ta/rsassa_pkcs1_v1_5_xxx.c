...
#include "include/rsassa_pkcs1_v1_5_xxx.h"
...
static TEE_Result generate_key(void **sess_ctx, uint32_t param_type, TEE_Param params[4])
{
    ...
    struct rsassa_pkcs1_v1_5_xxx_ctx *ctx = (struct rsassa_pkcs1_v1_5_xxx_ctx *)sess_ctx;
    TEE_Result res;
...
TEE_Result TA_OpenSessionEntryPoint(uint32_t param_type, TEE_Param params[4], void **sess_ctx)
{
    ...
    struct rsassa_pkcs1_v1_5_xxx_ctx *ctx = TEE_Malloc(sizeof(struct rsassa_pkcs1_v1_5_xxx_ctx),
...
{
    switch(cmd) {
        case RSASSA_PKCS1_V1_5_XXX_GEN_KEY:
            return generate_key(sess_ctx, param_type, params);
        
        case RSASSA_PKCS1_V1_5_XXX_DIGEST:
            return digest(sess_ctx, param_type, params);

        case RSASSA_PKCS1_V1_5_XXX_SIGN:
            return sign(sess_ctx, param_type, params);

        case RSASSA_PKCS1_V1_5_XXX_VERIFY:
